...
function OriginStory({ ref }: OriginStoryProps): React.JSX.Element {
  return (
...
function OriginStoryImage(): React.JSX.Element {
  return (
    <div className="lg:col-span-5 relative">
      <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-[rgba(212,175,55,0.15)]">
        <div className="absolute inset-0 bg-gradient-to-br from-[#0A0A0A] via-[var(--color-dark-card)] to-[#0A0A0A] flex flex-col items-center justify-center">
