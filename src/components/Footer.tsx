          ...
          <div className="footer-col col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                aria-label="WhatsApp"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="var(--color-muted)" className="hover:fill-[oklch(0.78_0.18_155)]">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full border border-[rgba(255,255,255,0.08)] flex items-center justify-center hover:border-[oklch(0.6_0.22_355)] hover:bg-[oklch(0.6_0.22_355)]/10 transition-all duration-300"
