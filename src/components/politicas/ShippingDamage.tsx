...
interface ShippingDamageProps {
  ref?: React.Ref<HTMLDivElement>
}

function ShippingDamage({ ref }: ShippingDamageProps): React.JSX.Element {
  return (
    <section
      ref={ref}
    ...
    >
      <div className="max-w-4xl mx-auto px-6">
        <div className="rounded-2xl border border-[rgba(212,175,55,0.12)] bg-[var(--color-bg)]/80 p-8 sm:p-10 md:p-14 relative overflow-hidden">
          <div
