...
const ProductCTA = forwardRef<HTMLDivElement, ProductCTAProps>(
  function ProductCTA({ quantity, onQuantityChange, whatsappLink, inStock }, ref) {
    return (
      <div ref={ref} className="flex flex-col gap-4 p-6 rounded-xl bg-[#0a0a0a] border border-white/5">
