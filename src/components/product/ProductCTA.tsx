  ...
  return (
    <div ref={ref} className="flex flex-col gap-4 p-6 rounded-xl bg-[var(--color-dark-card)] border border-white/5">
      ...
      <a
        ...
        className="flex items-center justify-center gap-3 w-full py-4 rounded-xl bg-gradient-to-r from-[var(--color-gold)] to-oklch(0.72 0.12 85) text-[var(--color-bg)] font-semibold text-sm hover:from-oklch(0.72 0.12 85) hover:to-oklch(0.65 0.12 80) transition-all duration-300 shadow-[0_4px_20px_rgba(212,175,55,0.3)] hover:shadow-[0_6px_30px_rgba(212,175,55,0.4)]"
        style={{ fontFamily: "var(--font-inter)" }}
      >
