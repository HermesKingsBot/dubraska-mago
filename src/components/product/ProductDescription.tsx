...
function ProductDescription({ product, descOpen, onToggleDesc, ref }: ProductDescriptionProps): React.JSX.Element {
  return (
    <div ref={ref} className="mt-6">
      ...
      >
        ...
        <svg
          ...
          stroke="currentColor"
          strokeWidth="2"
          className={`text-[var(--color-muted)] transition-transform duration-200 ${descOpen ? "rotate-180" : ""}`}
        >
              ...
              <tbody>
                {(
                  ...
                  .map(([label, value], i) => (
                    ...
                    >
                      <td className="px-4 py-2.5 text-[var(--color-muted)] border-r border-white/5">
                        {label}
                      </td>
