...
const DESCRIPTIONS: Record<string, string> = {
  Instagram: "Síguenos para ver nuevas piezas",
  WhatsApp: "Escríbenos para pedidos personalizados",
  Facebook: "Síguenos en Facebook",
  Email: "Para consultas y colaboraciones",
}
...
function ContactCards({ ref }: ContactCardsProps): React.JSX.Element {
  ...
  const cards = activeSocials.map((social) => ({
    platform: social.platform,
    handle: social.handle,
    description: DESCRIPTIONS[social.platform] || "Contáctanos",
    href: social.url,
    icon: PLATFORM_ICONS[social.platform] || PLATFORM_ICONS.Email,
  }))

  if (email && !cards.some((c) => c.platform === "Email")) {
    cards.push({
      platform: "Email",
      handle: email,
